...
isSmoothed = 'SMOOTHED';
Vn.ABS1 = imgaussfilt(Vn.ABS1, 'FilterSize', 3);
Vn.ABS2 = imgaussfilt(Vn.ABS2, 'FilterSize', 3);
...
sr_put_scale_vector(ax(1), screenCoef, xyScreenRatio,'task9Style','1 N/m^2',3.0);
